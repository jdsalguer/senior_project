...
**
** Created: Sat Mar 28 18:34:01 2015
...
static const char qt_meta_stringdata_loginsuccess[] = {
    "loginsuccess\0\0on_loginsucButton_clicked()\0"
};

const QMetaObject loginsuccess::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_loginsuccess,
      qt_meta_data_loginsuccess, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &loginsuccess::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_loginsuccess))
...
int loginsuccess::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: on_loginsucButton_clicked(); break;
        default: ;
        }
        _id -= 1;
    }
