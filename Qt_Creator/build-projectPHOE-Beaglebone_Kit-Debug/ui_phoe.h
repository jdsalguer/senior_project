...
public:
    ...
    void setupUi(QMainWindow *phoe)
    {
        ...
        layoutWidget1->setGeometry(QRect(170, 300, 451, 71));
        ...
        kb = new QPushButton(centralWidget);
        kb->setObjectName(QString::fromUtf8("kb"));
        kb->setGeometry(QRect(610, 160, 99, 27));
    ...
    void retranslateUi(QMainWindow *phoe)
    {
        ...
        kb->setText(QApplication::translate("phoe", "kb", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
